...
class QuestModel(models.Model):
    ...
    student1 = models.CharField(max_length=99, null = True, blank="True", default="", verbose_name="student 1",)
    student2 = models.CharField(max_length=99, null = True, blank="True", default="", verbose_name="student 2",)
    student3 = models.CharField(max_length=99, null = True, blank="True", default="", verbose_name="student 3",)
